...
\input{\econtexRoot/\ApndxDir/onlyinsubfile}\usepackage{ApndxSteadyState}
...
% Suppose we have an equiprobable discretized representation of the distribution of $\pLev$.  Specifically, we have a finite Markov chain $\Mrkv_{\finite}$ with $\NumAprxStes + 1$ discrete states in the set $\Nteger_{\NumAprxStesPls} \doteq \{1,2,\dots,\NumAprxStes,\NumAprxStesPls\}$ 
