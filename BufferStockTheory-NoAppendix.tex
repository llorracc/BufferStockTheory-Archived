...
\hfill{\tiny \jobname~\versn~\today, time:\DTMcurrenttime, commit: \input{.git-source-commit}}
...
\renewcommand{\forcedate}{September 27, 2020}
\date{\forcedate}
